	 ...
	 <!--GOLD BOX TEMPLATE STARTS HERE -->
			<div id="greenbox"><!-- GOLD box template!   -->
					<div class="box-outer">	
								...
								<tbody>
									<tr>
										...
										<td><br>
											...
											<input type="text" name="name" id="name" value="<?php echo $np->name ;?>" size="50" readonly>
										</td>
									</tr>					
									<tr>
									<td>
										...
										<td>
											<input type="text" name="org" id="org" value="<?php echo $np->org ;?>" size="50" readonly>
										</td>
									</tr>
								</tbody>
						...
						<div align="right">
       		 			<input type="button" name="delete" value="Delete this Entry" onclick="window.location='?unit=<?php echo $unit;?>&go=<?php echo $go;?>&task=deletenp&pid=<?php echo $pid?>'">
