...
<script type="text/javascript">
	...
	function checkEntry()
	{
		var campusName=document.getElementById('campusName').value;  <!--diri nag.start-->
						...
						<div class="content"> <!-- put your content here   -->											
								...
								<tr>							
									<td>
										...
										<td>
											<input type="text" name="campusName" id="campusName" value="<?php echo $c->campusName;?>" size="60">
										</td>										
								</tr>
								<tr>							
									<td>
										...
										<td>
											<input type="text" name="place" id="place" value="<?php echo $c->place;?>" size="60">
										</td>										
								</tr>
								<tr>							
									<td>
										...
										<td>
										 	<input type="text" name="dateEstablished"  id="dateEstablished" value="<?php echo $c->dateEstablished;?>" size="8" readonly  style="text-align:center;"/>            								
								...
								<tr>							
									<td>
										...
										<td>
											<input type="text" name="chancellor" id="chancellor" value="<?php echo $c->chancellor;?>" size="60">
										</td>										
								</tr>
								<!--nag.end-->
								</table>
       		 			...
       		 			<input type="button" name="cancel" value="Back"  onclick="window.location='?unit=<?php echo $unit;?>&go=<?php echo $go;?>&task=campus_index'">        		
 								...
 								<input type="hidden" name="campusID" value="<?php echo $c->campusID;?>">
								</form>
