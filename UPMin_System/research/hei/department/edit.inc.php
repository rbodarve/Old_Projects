...
<script type="text/javascript">
	...
	function checkEntry()
	{
		var deptName=document.getElementById('depttName').value;
						...
						<div class="content"> <!-- put your content here   -->											
								...
								<tr>							
									<td>
										...
										<td>
											<input type="text" name="deptCode" id="deptCode" value="<?php echo $d->deptCode;?>" size="30">
										</td>										
								</tr>
								<tr>							
									<td>
										...
										<td>
											<input type="text" name="deptName" id="deptName" value="<?php echo $d->deptName;?>" size="60">
										</td>
								...
								<tr>							
									<td>
										...
										<td>
											<input type="text" name="deptChair" id="deptChair" value="<?php echo $d->deptChair;?>" size="60">
										</td>
       		 			...
       		 			<input type="button" name="cancel" value="Back"  onclick="window.location='?unit=<?php echo $unit;?>&go=<?php echo $go;?>&task=department_index'">        		
 								...
 								<input type="hidden" name="deptID" value="<?php echo $d->deptID;?>">
								</form>
