...
<script type="text/javascript">
	...
	function checkEntry()
	{
		...
		var campusName=document.getElementById('campusName').selectedIndex;  <!--diri nag.start-->
						...
						<div class="content"> <!-- put your content here   -->											
								...
								<tr>							
									<td>
										...
										<td>
											<input type="text" name="collegeCode" id="collegeCode" value="<?php echo $c->collegeCode;?>" size="30">
										</td>
								...
								<tr>							
									<td>
										...
										<td>
											<input type="text" name="collegeName" id="collegeName" value="<?php echo $c->collegeName;?>" size="60">
										</td>
								...
								<tr>							
									<td>
										...
										<td>
											<input type="text" name="dean" id="dean" value="<?php echo $c->dean;?>" size="60">
										</td>										
								</tr>
							<!--	<tr>							
									<td>
										...
										<td>
											<input type="text" name="phoneNo" id="phoneNo" value="<?php echo $c->phoneNo;?>" size="60">
										</td>										
								</tr>   -->
								<!--diri nag.end-->
								</table>
       		 			...
       		 			<input type="button" name="cancel" value="Back"  onclick="window.location='?unit=<?php echo $unit;?>&go=<?php echo $go;?>&task=college_index'">        		
 								...
 								<input type="hidden" name="collegeID" value="<?php echo $c->collegeID;?>">
								</form>
