...
<script type="text/javascript">					
	...
	function deleteEntry(id){		
   		var ans=confirm("Are you sure you want to delete this?");
                if(ans){
                    window.location="?go=<?php echo $go;?>&unit=<?php echo $unit;?>&task=fundingagency_delete&fundAgencyID="+id;
                }   	
        }	 
					...
					<div class="box-outer">	
						...
						<div class="content"> <!-- put your content here   -->											
								<div align="right" class="action">
                                                                ...
                                                                ?>
								<a href="index.php?unit=<?php echo $unit;?>&go=<?php echo $go;?>&task=fundingagency_addNew" ><img src="images/new_f2.png" height="24px" width="24px" title="Add"></a>
                                                                <?php
                                                                                    }
                                                                ?>
								</div>
									...
									<tr>
										...
										<td style="text-align:right;padding-right:5px;">
                                                                                <?php
                                                                                    if($_SESSION['userType']==1){
                                                                                ?>
											<a href="index.php?unit=<?php echo $unit;?>&go=<?php echo $go;?>&task=fundingagency_edit&fundAgencyID=<?php echo $row['fundAgencyID'];?>" ><img src="images/edit_f2.png" height="24px" width="24px" title="Edit"></a>
