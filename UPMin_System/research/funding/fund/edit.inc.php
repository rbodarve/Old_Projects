						...
						<div class="content"> <!-- put your content here   -->											
								...
								<tr>							
									<td>
										...
										<td>
											<input type="text" name="fundName" id="fundName" value="<?php echo $f->fundName;?>" size="60">
										</td>
											...
											<select name="fundAgencyID" id="fundAgencyID">
												...
												<?php
													if($fa->count > 0)
													{
														...
														{
												?>		
														<option value="<?php echo $row['fundAgencyID'];?>" <?php if($f->fundAgencyID==$row['fundAgencyID']) echo "SELECTED";?>><?php echo $row['agencyName'];?></option>
												<?php
														}
													}
												?>
								...
								<tr>							
									<td>
										...
										<td>
										 	<input type="text" name="dateReceived"  id="dateReceived" value="<?php echo $f->dateReceived;?>" size="8" readonly  style="text-align:center;"/>            								
								...
								<tr>							
									<td>
										...
										<td>
											<input type="text" name="amount" id="amount" value="<?php echo $f->amount;?>" size="15" style="text-align:right;">
										</td>	
								</tr>	
								<tr>							
									<td style="vertical-align:top;">
										...
										<td>
											<textarea name="remarks" id="remarks" cols="60" rows="5"><?php echo $f->remarks;?></textarea>
										</td>
       		 			...
       		 			<input type="button" name="cancel" value="Back"  onclick="window.location='?unit=<?php echo $unit;?>&go=<?php echo $go;?>&task=fund_index'">        		
 								...
 								<input type="hidden" name="fundID" value="<?php echo $f->fundID;?>">
								</form>
