			...
			<div id="greenbox"><!-- GOLD box template!   -->
					<div class="box-outer">	
						...
						<div class="content"> <!-- put your content here   -->											
								...
								<tr>
									<th colspan="2">ADD NEW JOURNAL</th>								  									
								</tr>
								...
								<tr>							
									<td>
										...
										<td>
											<input type="text" name="ISSN" id="ISSN" value="" size="60">
										</td>										
								</tr>
								<tr>							
									<td>
										...
										<td>
											<input type="text" name="volume" id="volume" value="" size="60">
										</td>										
								</tr>
								<tr>							
									<td>
										...
										<td>
											<input type="text" name="editor" id="editor" value="" size="60">
										</td>										
								</tr> 
								<tr>							
									<td>
								...
								<tr>							
									<td>
										...
										<td>
											<input type="text" name="journalTitle" id="journalTitle" value="" size="60">
										</td>										
								</tr> 
								<tr>							
									<td>
										...
										<td>
											<input type="text" name="issue" id="issue" value="" size="60">
										</td>										
								</tr> 
								<!--nag.end-->
