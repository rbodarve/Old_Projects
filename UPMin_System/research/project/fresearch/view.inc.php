						...
						<div class="content"> <!-- put your content here   -->											
							...
							<table class="form" cellpadding="0" cellspacing="0" width="100%"> 
								...
								<td  style="font-weight:normal;">
										Publication ID:
										<span style="font-weight:bold;font-style:italic;padding-left:10px;"><?php echo $pu->publicationID;?></span>
										</td>		
								<tr>		
								<tr>							
								...
								<tr>
									<td  style="font-weight:normal;">
										Date Published:
										<span style="font-weight:bold;font-style:italic;padding-left:10px;"><?php echo $pu->datePublished;?></span>
										</td>											
								</tr>
