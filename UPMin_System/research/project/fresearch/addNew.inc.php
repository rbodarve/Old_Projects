...
<script type="text/javascript">
	...
	function checkEntry()
	{
		...
		var journalID=document.getElementById('journalID').selectedIndex;	
			...
			<div id="greenbox"><!-- GOLD box template!   -->
					<div class="box-outer">	
						...
						<div class="content"> <!-- put your content here   -->											
								...
								<tr>
									<th colspan="2">ADD NEW RESEARCH</th>								  									
								</tr>
								<tr>							
								...
								<tr>							
									...
									Research Title
										...
										<td>
											<input type="text" name="rtitle" id="rtitle" value="" size="60">
										</td>										
								</tr> 
								<!--nag.add-->
								<tr>							
								...
								<tr>							
									...
									Budget
										...
										<td>
											<input type="text" name="budget" id="budget" value="" size="60">
										</td>										
								</tr> 
								<tr>							
									<td style="vertical-align:top;">
