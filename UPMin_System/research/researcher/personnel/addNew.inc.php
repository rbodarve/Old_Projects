			...
			<div id="greenbox"><!-- GOLD box template!   -->
					<div class="box-outer">	
						...
						<div class="content"> <!-- put your content here   -->											
								...
								<tr>
									<th colspan="2">ADD NEW PERSONNEL</th>								  									
								</tr>
							<tr>							
									<td>
										Last Name
								...
								<tr>							
									<td>
										...
										<td>
											<input type="text" name="firstName" id="firstName" value="" size="60">
										</td>
								...
								<tr>							
									<td>
										...
										<td>
											<input type="text" name="middleName" id="middleName" value="" size="60">
										</td>
										...
										<td>
											<select name="collegeCode" id="collegeCode">
												...
												?>
														...
														<option value="<?php echo $row['collegeCode'];?>"><?php echo $row['collegeCode'];?></option>
												<?php
														}
													}
												?>
								...
								<tr>							
									<td>
										...
										<td>
											<input type="text" name="salary" id="salary" value="" size="60">
										</td>										
								</tr>
