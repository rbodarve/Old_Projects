						...
						<div class="content"> <!-- put your content here   -->											
								...
								<tr>						
									<td>
										...
										<td>
											<input type="text" name="projectName" id="projectName" value="" size="60">
										</td>										
								</tr>
								<tr>
									<td>
											...
											<select name="projTypeID" id="projTypeID">
												...
												<?php
													if($pt->count > 0)
													{
														...
														{
												?>
												<option value="<?php echo $row['projTypeID'];?>"><?php echo $row['projTypeName'];?></option>												
												<?php
														}
													}
												?>
											...
											<select name="fundID" id="fundID">
												...
												<?php
													if($f->count > 0)
													{
														...
														{
												?>
												<option value="<?php echo $row['fundID'];?>"><?php echo $row['fundName'];?></option>												
												<?php
														}
													}
												?>
								...
								<tr>
									<td>
										...
										<td>
											<input type="text" name="budget" id="budget" style="text-align:right;">
										</td>										
									</tr>
								<tr>
									<td>
											...
											<select name="projStatusID" id="projStatusID">
												...
												<?php
													if($ps->count > 0)
													{
														...
														{
												?>
												<option value="<?php echo $row['projStatusID'];?>"><?php echo $row['projStatusName'];?></option>												
												<?php
														}
													}
												?>
