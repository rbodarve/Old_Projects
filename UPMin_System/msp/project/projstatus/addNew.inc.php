...
$unit="msp";
$go="project";
$task="projstatus_save";
?>
<script type="text/javascript">

	function checkEntry()
	{
		var projstat=document.getElementById('projStatusName').value;
			...
			<div id="greenbox"><!-- GOLD box template!   -->
					<div class="box-outer">	
						...
						<div class="content"> <!-- put your content here   -->											
								...
								<tr>
									<th colspan="2">ADD NEW STATUS</th>								  									
								</tr>
								<tr>
										...
										<td>
											<input type="text" name="projStatusName" id="projStatusName" value="" size="60">
										</td>
