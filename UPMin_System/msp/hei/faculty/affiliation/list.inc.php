					...
					<div class="box-outer">	
						...
						<div class="tabs" align="left"> 	
        						<ul class="tabNavigation"> 
         						    ...
         						    <li><a href="index.php?unit=<?php echo $unit;?>&go=<?php echo $go;?>&task=affiliation_index&facultyID=<?php echo $facultyID;?>" style="color:#ffffff;font-style:italic;">School Affiliation</a></li> 
