					...
					<div class="box-outer">	
						...
						<div class="tabs" align="left"> 	
        						<ul class="tabNavigation"> 
         						    ...
         						    <li><a href="index.php?unit=<?php echo $unit;?>&go=<?php echo $go;?>&task=sdepartment_index&schoolID=<?php echo $schoolID;?>" style="color:#ffffff;font-style:italic;">Departments</a></li> 
