							...
							<table class="form" cellpadding="0" cellspacing="0" width="100%">
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<input type="text" name="descr" id="descr" value="<?php echo $training->descr;?>" size="120">
										</td>
									</tr>
									...
									<tr>
										...
										<td>
											<input  type="text" name="remarks" id="remarks" value="<?php echo $training->remarks;?>"size="120">
										</td>
