							...
							<table class="form" cellpadding="0" cellspacing="0" width="100%">
								...
								<tbody>
									...
									<tr>
										<td>
											View Certificate: 
											<?php $training->viewCert($training->training_id);?>
										</td>
										<td style="text-align:left;">											
											<!--<a href="index.php?unit=<?php echo $unit;?>&go=<?php echo $go;?>&task=viewfile&training_id=<?php echo $training->training_id;?>"><img src="images/attachments.png" height="24px" width="24px" title="View Certificate"></a>-->
											<a href="modules/pt/uploads/<?php echo $training->cert?>"><img src="images/attachments.png" height="24px" width="24px" title="View Certificate"></a>
										</td>
									</tr>
									</tbody>
							</table>											
