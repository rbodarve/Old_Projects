...
class fund extends Core {
	...
	function loadAll()
	{
		$sql="SELECT * FROM $this->coreTable as a left join upmin_msp.fundagency as b on a.fundAgencyID=b.fundAgencyID order by fundName asc";
		//echo $sql;
		 $this->Execute($sql);		   	
	   	 return $this->sqlOK;  		
	}
