...
%6 - the maximum element in the list [H|T] is located at position P

indexOf([H|_], H, 0).
indexOf([_|T], H, Index):- indexOf(T, H, Index1), Index is Index1+1.

maxpos([H|T],P) :- getmax([H|T],M), indexOf([H|T],M,Z), P is Z+1.
