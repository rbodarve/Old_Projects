...
[![README style](https://img.shields.io/badge/README-Amazing%20GitHub%20Template-brightgreen.svg)](https://github.com/dec0dOS/amazing-github-template)
...
> **⚠️ This is a fork.** This copy is a fork of the upstream project
> [**7ossam81/EvoloPy**](https://github.com/7ossam81/EvoloPy), synced to **v4.0.6** (upstream
> master @ `ce97ecf`). A static review of this version logged known bugs (e.g. an advertised
> `F24` benchmark that does not exist, and API bounds silently ignored) in
> [`../issues-evolopy.txt`](../issues-evolopy.txt) — **not all are fixed yet**. Full source,
> license, and per-algorithm references belong to the upstream authors; see
...
EvoloPy is licensed under the MIT License. Copyright belongs to the upstream EvoloPy authors;
this fork redistributes under the same terms.

## 🙏 Acknowledgements & Sources

- **Upstream project** — this is a fork of [**7ossam81/EvoloPy**](https://github.com/7ossam81/EvoloPy),
  synced to **v4.0.6** (upstream master @ `ce97ecf`). All library source and design credit is
  upstream's; this copy adds only a review log ([`../issues-evolopy.txt`](../issues-evolopy.txt)).
- **Primary citation** — Faris, H., Aljarah, I., Mirjalili, S., Castillo, P. A., & Merelo, J. J.
  (2016). *EvoloPy: An Open-source Nature-inspired Optimization Framework in Python.* IJCCI
  (ECTA), 171–177. (BibTeX above under [Citation](#-citation).)
- **Algorithm references** — each optimizer's original authors and year are listed inline under
  [Optimization Algorithms in Detail](#-optimization-algorithms-in-detail) (e.g. Kennedy &
  Eberhart 1995 for PSO; Mirjalili 2014 for GWO; Yang & Deb 2009 for CS; Heidari et al. 2019 for
  HHO). Please cite the corresponding original paper when using a specific algorithm.
- **README template** — [Amazing GitHub Template](https://github.com/dec0dOS/amazing-github-template)
  by **dec0dOS**, discovered via [awesome-readme](https://github.com/matiassingers/awesome-readme)
